  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-6 shadow">
      <div class="modal-body p-5">
        <h2 class="fw-bold mb-0">Coursera Assigment File in Cloud Object Storage</h2>

        <ul class="d-grid gap-4 my-5 list-unstyled">

          <li class="d-flex gap-4">
            <p class="mb-0">Creating Buckets</p>
          </li>
          <li class="d-flex gap-4">
            <p class="mb-0">Adding Objects to them</p>
          </li>
          <li class="d-flex gap-4">
            <p class="mb-0">and Sharing them with others</p>
          </li>
